...
هذا المشروع يُظهر كيفية استخدام الشبكة Grid في تصميم لوحات تجريدية بألوان وأشكال هندسية بسيطة ويظهر مدى قوة CSS Grid في التحكم بالتصميم وتحويل العمل على الcss أمر أبسط بكثير.
